...
// Estendendo o tipo Template para incluir as propriedades usadas no componente
      ...
      <Table data-testid={`${dataTestId}-table`}>
        <TableHeader data-testid={`${dataTestId}-header`}>
          <TableRow data-testid={`${dataTestId}-header-row`}>
            ...
            <TableHead data-testid={`${dataTestId}-head-category`}>Categoria</TableHead>
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Link
                          ...
                          aria-label={`Abrir repositório ${template.repositoryUrl}`}
                        >
                          {template.repositoryUrl.split('/').pop()}
        ...
        <TableBody data-testid={`${dataTestId}-body`}>
          {Array.from({ length: 3 }).map((_, index) => (
            <TableRow key={index} data-testid={`${dataTestId}-skeleton-row-${index}`}>
              ...
              <TableCell data-testid={`${dataTestId}-skeleton-category-${index}`}>
